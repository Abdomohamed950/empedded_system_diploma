...
//	*configreg &= ~(0xf<<((PinConfig->GPIO_PinNumber-1)%8)*4);
//
//	if(PinConfig->GPIO_MODE>3)
//	{
//		*configreg |= (PinConfig->GPIO_MODE-4)<<((((PinConfig->GPIO_PinNumber-1)%8) *4) +2);
//		*configreg |= PinConfig->GPIO_Output_Speed<<(((PinConfig->GPIO_PinNumber-1)%8) *4);
//	}
//
//	else
//	{
...
//			//01
//			*configreg |= PinConfig->GPIO_MODE<<((((PinConfig->GPIO_PinNumber-1)%8) *4) +2);
//			break;
